namespace ConfIT.UnitTest.Util
{
    public class SemanticMatcherTests
    {
        ...
        // ── Mixed semantic + pattern + ignore ──────────────────────────────────

        [Fact]
        public void MatchResponseBody_ShouldHandle_SemanticPatternAndIgnoreTogether()
        {
            // Given
            ...
            var matcher = new Matcher
            {
                ...
                Ignore = new List<string> { "createdAt" }
            };
        ...
        public void Apply_ShouldUseCustomMatcher_WhenNameNotInBuiltIns()
        {
            ...
            var expected = JToken.Parse("{}");
            var customMatchers = new Dictionary<string, SemanticMatcherFunc>
            {
                ["isDomainId"] = (token, _) =>
            ...
            // When
            var action = () => SemanticMatcher.Apply(actual, expected,
                new Dictionary<string, string> { ["code"] = "isDomainId" }, customMatchers);
