...
|----|---------|-----------|
| [FLOW-001] | [Variable Extraction + Injection](features/flow-001.md) | Extract response values, inject into subsequent tests. Eliminates ~80% of `ITestProcessor` usage. |
| [ASSERT-001] | Semantic Matcher Library | Type-aware assertions: `isUuid`, `isIsoDate`, `greaterThan`, `hasLength`, `isNull`, and more. |
